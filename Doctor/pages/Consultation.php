                ...
                <div class="info_specifique d-flex">
                    <div class="pat_log">
                        ...
                        <button class="btn btn-warning" id="<?php echo isset($_GET["update"])?"modifier":"save"?>"
                            <?php echo (!isset($_GET["update"]) && !isset($_GET["cin"]) && isset($_GET["id"]))?"disabled":""?>><?php echo isset($_GET["update"])?"modifier":"Enrigistrer"?></button>
                    </div>
                    <div class="info_patient">
...
$("#save").click(function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            window.location.href = "Consultation.php?id=" + getID + "&update=Update"
        }
    })
});
